...
- **sendArray** (boolean) - send logs to remote endpoint as a JSON array (true), or as an object under the 'logs' key (false).

- **tokenLabel** (string) - label to use for Authorization header, e.g. 'JWT' (default), 'Bearer' or 'Token'.
